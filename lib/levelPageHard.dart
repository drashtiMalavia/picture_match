...
class level_page_hard extends StatefulWidget {
  const level_page_hard({super.key});

  @override
  State<level_page_hard> createState() => _level_page_hardState();
}

class _level_page_hardState extends State<level_page_hard> {
  @override
                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, indexsecond) {
                          var currentlevelnumber=(indexfirst*10)+indexsecond;
                          if (indexsecond==0) {
                            return Stack(
                              children: [
                                Row(
                            ...
                            return (Data.levelStatusHard[currentlevelnumber-1]=='win')?
                            InkWell(
                              onTap: () {
                                setState(() {
                                  Navigator.push(context,MaterialPageRoute(builder: (context) {
                                    return game_page(currentlevelnumber);
                                  },));
                                });
                              },
                              child: Container(
                                ...
                                child: Text("LEVEL ${currentlevelnumber} ${Preference.getTimeHard(currentlevelnumber)}s",style: TextStyle(color: Colors.white,fontSize: 20)),
                                alignment: Alignment.center,
                              ),
                            ):
                            IgnorePointer(
                              ignoring: (currentlevelnumber!=1?(Data.levelStatusHard[currentlevelnumber-2]=='win' && Data.levelStatusHard[currentlevelnumber-1]=='pending'):(currentlevelnumber==1))?false:true,
                              child: InkWell(
                                onTap: () {
                                  setState(() {
                                    Navigator.push(context,MaterialPageRoute(builder: (context) {
                                ...
                                child: Container(
                                  height: 40,
                                  width: 30,
                                  color: (currentlevelnumber!=1?(Data.levelStatusHard[currentlevelnumber-2]=='win' && Data.levelStatusHard[currentlevelnumber-1]=='pending'):(currentlevelnumber==1))?Colors.teal:Colors.teal[100],
                                  margin: EdgeInsets.only(top: 20,left: 20,right: 20),
                                  child: Text("LEVEL ${indexsecond}",style: TextStyle(color: Colors.white,fontSize: 20)),
                                  alignment: Alignment.center,
                                ),
                              ),
                            );
