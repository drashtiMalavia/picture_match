...
class level_page_Normal extends StatefulWidget {
  const level_page_Normal({super.key});
  @override
  State<level_page_Normal> createState() => _level_page_NormalState();
}

class _level_page_NormalState extends State<level_page_Normal> {
  @override
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (index==0) {
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        child: Text("${index1==0?'MATCH 2':index1==1?'MATCH 3':index1==2?'MIRROR':index1==3?'MIRROR 3':index1==4?'MATCH 4':'MIRROR 4'}",
                                          style: TextStyle(
                                              color: Colors.teal,
                                              fontSize: 20,
                              ...
                              return (Data.levelStatusNormal[levelNo-1]=='win')?
                              InkWell(
                                onTap: () {
                                  setState(() {
                                    Navigator.push(context,MaterialPageRoute(builder: (context) {
                                      return game_page(levelNo);
                                    },));
                                  });
                                },
                                child: Container(
                                  ...
                                  child: Text("LEVEL ${levelNo} ${Preference.getTimeNormal(levelNo)}s",style: TextStyle(color: Colors.white,fontSize: 20)),
                                  alignment: Alignment.center,
                                ),
                              ):
                              IgnorePointer(
                                ignoring: (levelNo!=1?(Data.levelStatusNormal[levelNo-2]=='win' && Data.levelStatusNormal[levelNo-1]=='pending'):(levelNo==1))?false:true,
                                child: InkWell(
                                  onTap: () {
                                    setState(() {
                                      Navigator.push(context,MaterialPageRoute(builder: (context) {
                                  ...
                                  child: Container(
                                    height: 40,
                                    width: 30,
                                    color: (levelNo!=1?(Data.levelStatusNormal[levelNo-2]=='win' && Data.levelStatusNormal[levelNo-1]=='pending'):(levelNo==1))?Colors.teal:Colors.teal[100],
                                    margin: EdgeInsets.only(top: 20,left: 20,right: 20),
                                    child: Text("LEVEL ${index}",style: TextStyle(color: Colors.white,fontSize: 20)),
                                    alignment: Alignment.center,
                                  ),
                                ),
                              );
